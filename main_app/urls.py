...
urlpatterns = [
    ...
    path('cities/', views.cities_index)
    ...
    path('posts/<int:post_id>/edit', views.post_edit, name='posts_edit'),
    path('posts/<int:post_id>/delete', views.post_delete, name='posts_delete'),
